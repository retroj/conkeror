...
define_key(content_buffer_text_keymap, "C-y", "yank");
define_key(content_buffer_text_keymap, "C-w", "kill-region");
define_key(content_buffer_text_keymap, "M-w", "kill-ring-save");
define_key(content_buffer_text_keymap, "C-k", "cut-to-end-of-line");
define_key(content_buffer_text_keymap, "S-delete", "kill-region");
